...
const sources=['ClubJSON','ClubCore','ClubSession','ClubStore','ClubApp','ClubHome','ClubMenu','ClubRewards','ClubAccount'].map(n=>`Sources/${n}.swift`);
...
put(4,`isa=PBXNativeTarget;buildConfigurationList=${id(11)};buildPhases=(${id(6)},${id(7)},${id(8)});buildRules=();dependencies=();name=HOPClub;productName=HOPClub;productReference=${id(5)};productType="com.apple.product-type.application";`);
put(5,'isa=PBXFileReference;explicitFileType=wrapper.application;includeInIndex=0;path=HOPClub.app;sourceTree=BUILT_PRODUCTS_DIR;');
