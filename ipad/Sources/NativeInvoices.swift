...
struct NativeInvoiceStudio:View {
    ...
    }.task {doc=isNew ? original : HOPMoney.editableInvoice(original);changed=false}.onChange(of:doc) {old,new in if old != .null && old != new {changed=true}}
