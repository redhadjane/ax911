# Sonata Diagnostic — Premium iPhone Edition
...
## Safety model
Version 1.0 is read-only. It does not transmit Hyundai module configuration writes, immobilizer commands, SRS/ABS coding, or engine calibration commands.
...
- v1.0.0 rebuilds the interface around the iPhone 16 Pro viewport, adds a true full-height application shell, compact premium density, interactive vehicle tilt, scenario-aware on-device Intelligence guidance, and automated simulator screenshots for visual QA
